...
**Pro plan limits:** Pro allows 3 stores per team. If you want to run shadow-canary on 4+ projects, share one store across them — keys are namespaced by repo slug so collisions are impossible. See [Sharing a store across projects](/shadow-canary/concepts/edge-config/#sharing-a-store-across-projects).
